...
public class CustomerApi {
	...
	public List<Customer> findBynName(@RequestParam String name) {
		return dao.findCustomerByName(name);
	}

	@GetMapping(value = "customer/findByName2")
	public List<Customer> findBynName2(@RequestParam String name) {
		return dao.findCustomerByName(name);
	}
	...
	public List<Customer> findByLevel(@PathVariable Integer level){
		return dao.findByLevelOrderById(level);
	}
}
